...
public class Missile : MonoBehaviour
{
    ...
    void Guided()
    {
        ...
        Vector3 angleError = targetVec - this.transform.position;//시커가 바라보는 적 방향
        angleError = seeker.transform.InverseTransformDirection(angleError).normalized;//정규화 + 로컬화
        angleError_diff = angleError - angleError_temp;//미분항
